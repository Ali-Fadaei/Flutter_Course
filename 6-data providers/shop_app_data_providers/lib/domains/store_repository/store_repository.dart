  ...
  Future<List<Product>> readProducts({
    ...
    final res = await ShopApi.client.get(
      ...
      queryParams: {
        'start': 0,
        'offset': 100,
        // if (categoriesId != null) 'categoryId': categoriesId?.first.toString(),
        if (title != null) 'title': title,
        if (minRating != null) 'minRate': minRating,
        if (maxRating != null) 'maxRate': maxRating,
        if (minPrice != null && (minPrice ?? 0) > 0) 'minPrice': minPrice,
        if (maxPrice != null && (maxPrice ?? 0) > 0) 'maxPrice': maxPrice,
